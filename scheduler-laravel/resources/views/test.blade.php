...
<head>
    ...
    <script src="{{asset('scheduler_trial/codebase/dhtmlxscheduler.js')}}" type="text/javascript" charset="utf-8"></script>
    <link rel="stylesheet" href="{{asset('scheduler_trial/codebase/dhtmlxscheduler.css')}}" type="text/css" charset="utf-8">
